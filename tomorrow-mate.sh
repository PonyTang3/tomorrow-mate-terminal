...
if [ -z "${PROFILES}" ]; then
    PROFILES="['default','tomorrow-night']"
elif [[ ${PROFILES} =~ 'tomorrow-night' ]]; then
    echo "Found tomorrow-night in your themes, refusing to run twice"
...
dconf write /org/mate/terminal/profiles/${PROFILE}/visible-name \"tomorrow-night\"
